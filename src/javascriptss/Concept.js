...
export default App;
*/
//using the cursely brackets we are performing the javascript code 
//jsx is used for the html and the code type 
//using this we can add the one more html element in the return type with out error 
